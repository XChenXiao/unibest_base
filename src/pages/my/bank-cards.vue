    ...
    <view class="card-container" v-if="isActivated">
      ...
      <view class="card-form" v-if="showAddCardForm">
        ...
        <view class="form-group">
          ...
          <input type="text" class="form-input" v-model="newCard.card_holder" placeholder="请输入持卡人姓名" placeholder-class="input-placeholder" />
        </view>
        <view class="form-group">
          <text class="form-label">银行名称</text>
          <input type="text" class="form-input" v-model="newCard.bank_name" placeholder="请输入银行名称" placeholder-class="input-placeholder" />
        </view>
        <view class="form-group">
          <text class="form-label">银行卡号</text>
          <input type="text" class="form-input" v-model="newCard.card_number" placeholder="请输入完整的银行卡号" placeholder-class="input-placeholder" />
        </view>
        <!-- <view class="form-group">
      ...
      <view class="card-list" v-if="cards.length > 0">
        <view class="bank-card" v-for="card in cards" :key="card.id">
          ...
          <view class="card-actions">
            <button class="btn-default" @click="setAsDefault(card.id)" :disabled="card.is_default">设为默认</button>
...
const isProcessing = computed(() => {
  return bankCardStatus.latest_application !== null && 
